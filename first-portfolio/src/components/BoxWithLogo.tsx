...
export const BoxWithLogo: React.FC<BoxWithLogoProps> = ({url, children, className}) => {
    ...
    return (
        <div className={`${className ? className : "gap-3 xl:w-[350px] 2xl:w-full sm:w-[170px] text-[13px]"} mb-1  xl:mb-2  2xl:text-[14px] sm:items-center flex flex-row bg-defaultGray items-center rounded-[7px] text-white font-montserrat font-extrabold`}>
           { url ?  (
                 <CropImage
