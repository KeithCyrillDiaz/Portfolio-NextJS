...
export const HamburgerMenuSVG: React.FC = () => {
    return(
        <SVGComponent>
             <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full" viewBox="0 0 24 24"><path fill="none" stroke="#1db954" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M3 6h18M3 12h18M3 18h18"/></svg>
        </SVGComponent>
    )
}
...
type  CircleSVGProps = {
 ...
 export const CloseSVG: React.FC<CircleSVGProps> = ({className}) => {
    return (
        <SVGComponent>
           <svg xmlns="http://www.w3.org/2000/svg" className={`${className ?? "w-[30%] h-[30%]"}`} viewBox="0 0 24 24"><path fill="#1DB954" d="M6.4 19L5 17.6l5.6-5.6L5 6.4L6.4 5l5.6 5.6L17.6 5L19 6.4L13.4 12l5.6 5.6l-1.4 1.4l-5.6-5.6z"/></svg>
        </SVGComponent>
    )
 }